package com.primemedia.dooocustom.ui.constant;
...
public class AppConfig {
    ...
    public static String facebook_interstitial_ads_placement_id = "";
...
//    public static int webSeriesEpisodeitem = R.layout.episode_item;
    ...
    public static int webSeriesEpisodeitem;
    public static int small_live_tv_channel_item;
    public static Object live_tv_channel_item;
    //<!------------------------------------------------------------------->//
